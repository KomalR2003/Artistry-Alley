        ...
        <div className="w-full h-full bg-white text-[#171C3C] p-8 overflow-y-auto">
            ...
            <div className="mb-8">
                ...
                <p className="text-[#171C3C]/70 mt-2">
                    Browse our exclusive art products.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className="bg-[#98C4EC]/10 p-6 rounded-xl border border-[#98C4EC]/40 hover:shadow-lg transition-shadow">
                    ...
                    <p className="text-sm text-[#171C3C]/60">Products</p>
                </div>

                <div className="bg-[#D1CAF2]/10 p-6 rounded-xl border border-[#D1CAF2]/40 hover:shadow-lg transition-shadow">
                    <ShoppingBag className="w-8 h-8 text-[#D1CAF2] mb-3" />
                    <h3 className="text-2xl font-bold text-[#171C3C]">500+</h3>
                    <p className="text-sm text-[#171C3C]/60">Sold</p>
                </div>

                <div className="bg-[#FE9E8F]/10 p-6 rounded-xl border border-[#FE9E8F]/40 hover:shadow-lg transition-shadow">
                    <Star className="w-8 h-8 text-[#FE9E8F] mb-3" />
                    <h3 className="text-2xl font-bold text-[#171C3C]">4.8</h3>
                ...
                <div className="bg-white p-6 rounded-xl border border-[#171C3C]/20 hover:shadow-lg transition-shadow">
                    <TrendingUp className="w-8 h-8 text-[#171C3C]/60 mb-3" />
                    <h3 className="text-2xl font-bold text-[#171C3C]">98%</h3>
                    <p className="text-sm text-[#171C3C]/60">Satisfaction</p>
                </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#98C4EC]/10 via-white to-[#D1CAF2]/10 rounded-2xl border border-[#98C4EC]/40 p-12 text-center">
                ...
                <h2 className="text-2xl font-bold text-[#171C3C] mb-2">Product Catalog</h2>
                <p className="text-[#171C3C]/60">Discover exclusive art products and prints from talented artists</p>
            </div>
        </div>
    );
}
